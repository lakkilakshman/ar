...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DieTMTjq.js");
...
const manifest = { "3d2e99b45e2882a4173fd21ceaa20ca741129ca5fa4868bce25b4278795eeeaf": {
  functionName: "getStripeEnabled_createServerFn_handler",
  importer: () => import("./assets/stripe-0mIrZmSZ.js")
}, "331287a1bf0e39b2e44801cb3b35904ce6c343245195fa09bb019bb3f15ea58c": {
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-DA5bQKbQ.js").then((n) => n.r);
  return {
